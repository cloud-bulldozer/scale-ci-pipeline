...
stage ('OCP 4.X INSTALL') {
	if (ocp_install == "TRUE") {
		...
		node(node_label) {
			...
			def openshift_alertmanager_storage_size = openshiftv4_properties['OPENSHIFT_ALERTMANAGER_STORAG			def kubeconfig_auth_dir_path = openshiftv4_properties['KUBECONFIG_AUTH_DIR_PATH']			
