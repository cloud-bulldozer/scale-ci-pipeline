	...
	if (ocp_install == "TRUE") {
		...
		node(node_label) {
			...
			if ( scale_ci_build_trigger.toBoolean() ) {
				sh "curl ${scale_ci_build_trigger_url}/payload -o /tmp/payload.osp"
			...
			try {
				...
				parameters: [  	[$class: 'StringParameterValue', name: 'ORCHESTRATION_USER', value: orchestration_user ],
						...
						[$class: 'BooleanParameterValue', name: 'OSP_PUBLIC_EXTERNAL_INTERFACE', value: Boolean.valueOf(osp_public_external_interface) ],
